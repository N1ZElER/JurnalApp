...
import com.example.jurnals.Adapter.OzevsAdapter;
...
public class Ozevs extends AppCompatActivity {
    ...
    private List<com.example.jurnals.Models.Ozevs> ozevsList = new ArrayList<>();
    ...
    private void loadOzevs() {
        ...
        api.getOzevs("Bearer " + token).enqueue(new Callback<List<com.example.jurnals.Models.Ozevs>>() {
            @Override
            public void onResponse(Call<List<com.example.jurnals.Models.Ozevs>> call,
                                   Response<List<com.example.jurnals.Models.Ozevs>> response) {
                swipeRefresh.setRefreshing(false);

                if (response.isSuccessful() && response.body() != null) {
                    List<com.example.jurnals.Models.Ozevs> newOzevs = response.body();
            ...
            @Override
            public void onFailure(Call<List<com.example.jurnals.Models.Ozevs>> call, Throwable t) {
                swipeRefresh.setEnabled(false);
                swipeRefresh.setRefreshing(false);
